...
public class Pessoa {
	...
	// No Banco de dados será, ainda, uma coisa só, uma única tabela. Criada na
	// migração V02...
	...
	// Para o Json e o Hibernate não pensar que "isInativo" é uma propriedade, por causa do "is"
	// coloca-se esses:
	@JsonIgnore
	@Transient
