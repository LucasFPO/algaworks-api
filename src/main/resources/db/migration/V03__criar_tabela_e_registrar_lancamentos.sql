CREATE TABLE lancamento (
	...
	/* O "tipo" não é uma tabela, e sim um Enum. */
	tipo VARCHAR(20) NOT NULL,  
	
	 /* Relacionamento para essa coluna, definido no Lancamento.java */
	codigo_categoria BIGINT(20) NOT NULL,
	
	/* Relacionamento para essa coluna, definido no Lancamento.java */
	codigo_pessoa BIGINT(20) NOT NULL,	
	
	/* "FOREING KEY" é para fazer a ligação de uma tabela com outra tabela, como "categoria" e "pessoa" */
